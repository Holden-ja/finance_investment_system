...
''',
        ...
        '上游': ['天齐锂业', '赣锋锂业', '华友钴业', '恩捷股份', '星源材质', '璞泰来'],
        '中游': ['宁德时代', '比亚迪', '亿纬锂能', '国轩高科', '欣旺达', '汇川技术'],
        '下游': ['特锐德', '盛弘股份', '绿能慧充', '英可瑞']
    },
    'AI算力': {
...
''',
        ...
        '上游': ['合盛硅业', '通威股份', '大全能源', '隆基绿能'],
        '中游': ['中芯国际', '长电科技', '中际旭创', '中天科技', '亨通光电'],
        '下游': ['中科曙光', '浪潮信息', '宝信软件', '光环新网']
    },
    '电力能源': {
        'desc': '电力能源完整产业链',
        '全链图': '''
...
''',
        ...
        '上游': ['沪硅产业', '立昂微', '华懋科技', '彤程新材', '华特气体'],
        '中游': ['中芯国际', '长电科技', '通富微电', '华天科技'],
        '下游': ['韦尔股份', '兆易创新', '圣邦股份']
    },
    '光伏': {
        'desc': '光伏完整产业链',
...
''',
        ...
        '上游': ['通威股份', '大全能源', '新特能源', '隆基绿能', 'TCL中环'],
        '中游': ['晶科能源', '天合光能', '晶澳科技', '阳光电源', '上能电气'],
        '下游': ['特变电工', '正泰电器']
    },
    '医药': {
        'desc': '医药完整产业链',
...
''',
        ...
        '上游': ['普洛药业', '九洲药业', '新和成', '浙江医药'],
        '中游': ['恒瑞医药', '药明康德', '迈瑞医疗', '康龙化成'],
        '下游': ['爱尔眼科', '益丰药房', '大参林']
    },
    '白酒': {
        'desc': '白酒完整产业链',
...
def print_chain_diagram():
    ...
    for industry, data in INDUSTRY_CHAINS_FULL.items():
...
def analyze_stocks_by_industry():
    """按行业分析股票"""
    print('=' * 80)
    print('  行业股票分析 (0-30元)')
    print('=' * 80)
...
def main():
    ...
    print()
    print('=' * 80)
    print('  财经投资决策分析系统 v3.0')
    print('  Finance Investment Decision Analysis System')
    print('=' * 80)
    print()
